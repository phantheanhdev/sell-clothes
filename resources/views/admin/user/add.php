<h1 class="mt-4 text-uppercase">ADD user</h1>
...
<div class="card mb-4">
    <form action="/ad_save_add_user" method="post" class="mx-5 mt-3" enctype="multipart/form-data" onsubmit="return validate()">

        <!-- text -->
        <div class="mb-3">
            <label class="form-label">Full name</label>
            <input type="text" class="form-control" name="us_full_name" id="us_full_name">
            <span class="form-text" id="err_us_full_name" style="color: red;"> </span>
        </div>
        <div class="mb-3">
            <label class="form-label">Account name</label>
            <input type="text" class="form-control" name="us_acc_name" id="us_acc_name">
            <span class="form-text" style="color: red;" id="err_us_acc_name"> </span>
        </div>
        <div class="mb-3">
            <label class="form-label">Pass</label>
            <input type="text" class="form-control" name="us_pass" id="us_pass">
            <span class="form-text" style="color: red;" id="err_us_pass"> </span>
        </div>
        <div class="mb-3">
            <label class="form-label">Address</label>
            <input type="text" class="form-control" name="us_address" id="us_address">
