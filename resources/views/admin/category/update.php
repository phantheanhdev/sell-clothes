<h1 class="mt-4 text-uppercase">update categories</h1>

<a href="/ad_list_categories">
    <button type="button" class="btn btn-outline-secondary mb-4 mt-3">List categories</button>
</a>
<div class="card mb-4">
    <form action="/ad_save_update_categories" method="post" class="mx-5 mt-3" enctype="multipart/form-data" onsubmit="return validate()">

        <input type="hidden" value="<?= $category->ct_id ?>" name="ct_id">
        <!-- text -->
        <div class="mb-3">
            <label class="form-label">Name</label>
            <input type="text" class="form-control" name="ct_name" id="pro_name" value="<?= $category->ct_name ?>">
