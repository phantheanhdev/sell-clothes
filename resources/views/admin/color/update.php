<h1 class="mt-4 text-uppercase">update colors</h1>

<a href="/ad_list_color">
    <button type="button" class="btn btn-outline-secondary mb-4 mt-3">List colors</button>
</a>
<div class="card mb-4">
    <form action="/ad_save_update_color" method="post" class="mx-5 mt-3" enctype="multipart/form-data" onsubmit="return validate()">

        <input type="hidden" value="<?= $color->cl_id ?>" name="cl_id">
        <!-- text -->
        <div class="mb-3">
            <label class="form-label">Name</label>
            <input type="text" class="form-control" name="cl_name" id="pro_name" value="<?= $color->cl_name ?>">
