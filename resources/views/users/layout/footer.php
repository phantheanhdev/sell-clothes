  ...
  <footer>
    <div class="container">
      <div class="row">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-3 col-sm-5">
                <h3 class="">Đăng ký nhận tin sản phẩm mới</h3>
                <span>Nhận các ưu đãi mới nhất và ưu đãi đặc biệt</span>
              </div>
        ...
        <div class="col-sm-6 col-md-4 col-xs-12 col-lg-3">
          <div class="footer-logo"><a href="/home"><img src="images/footer-logo.png" alt="fotter logo"></a> </div>
          <div class="footer-content">
            <div class="email"> <i class="fa fa-envelope"></i>
              <p><a href="#" class="" style="color: white;">
                  phananh.main@mail.com
                </a></p>
            </div>
        ...
        <div class="col-sm-6 col-md-3 col-xs-12 col-lg-3 collapsed-block">
          <div class="footer-links">
            <h3 class="links-title">Người dùng<a class="expander visible-xs" href="#TabBlock-3">+</a></h3>
            <div class="tabBlock" id="TabBlock-3">
              <ul class="list-links list-unstyled">
                <li> <a href="sitemap.html"> Bản đồ trang web </a> </li>
    ...
    <div class="footer-coppyright">
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-xs-12 coppyright"> Copyright © 2023 <a href="#"> Fancy </a>đã đăng ký bản quyền</div>
